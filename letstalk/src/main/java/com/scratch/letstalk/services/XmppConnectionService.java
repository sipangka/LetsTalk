package com.scratch.letstalk.services;
...
import com.scratch.letstalk.Config;
import com.scratch.letstalk.R;
import com.scratch.letstalk.crypto.PgpEngine;
import com.scratch.letstalk.entities.Account;
import com.scratch.letstalk.entities.Bookmark;
import com.scratch.letstalk.entities.Contact;
import com.scratch.letstalk.entities.Conversation;
import com.scratch.letstalk.entities.Message;
import com.scratch.letstalk.entities.MucOptions;
import com.scratch.letstalk.entities.MucOptions.OnRenameListener;
import com.scratch.letstalk.entities.Presences;
import com.scratch.letstalk.generator.IqGenerator;
import com.scratch.letstalk.generator.MessageGenerator;
import com.scratch.letstalk.generator.PresenceGenerator;
import com.scratch.letstalk.parser.IqParser;
import com.scratch.letstalk.parser.MessageParser;
import com.scratch.letstalk.parser.PresenceParser;
import com.scratch.letstalk.persistance.DatabaseBackend;
import com.scratch.letstalk.persistance.FileBackend;
import com.scratch.letstalk.ui.UiCallback;
import com.scratch.letstalk.utils.CryptoHelper;
import com.scratch.letstalk.utils.ExceptionHelper;
import com.scratch.letstalk.utils.OnPhoneContactsLoadedListener;
import com.scratch.letstalk.utils.PRNGFixes;
import com.scratch.letstalk.utils.PhoneHelper;
import com.scratch.letstalk.utils.UIHelper;
import com.scratch.letstalk.xml.Element;
import com.scratch.letstalk.xmpp.OnBindListener;
import com.scratch.letstalk.xmpp.OnContactStatusChanged;
import com.scratch.letstalk.xmpp.OnIqPacketReceived;
import com.scratch.letstalk.xmpp.OnMessageAcknowledged;
import com.scratch.letstalk.xmpp.OnStatusChanged;
import com.scratch.letstalk.xmpp.XmppConnection;
import com.scratch.letstalk.xmpp.jingle.JingleConnectionManager;
import com.scratch.letstalk.xmpp.jingle.OnJinglePacketReceived;
import com.scratch.letstalk.xmpp.jingle.stanzas.JinglePacket;
import com.scratch.letstalk.xmpp.pep.Avatar;
